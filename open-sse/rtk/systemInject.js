// Shared format-aware system-message injector. Used by caveman AND ponytail
// so they compose on a single parsed body (no double parse/serialize).
import { FORMATS } from "../translator/formats.js";

const SEP = "\n\n";

export function injectSystem(body, format, prompt) {
  ...
  switch (format) {
    ...
    case FORMATS.ANTIGRAVITY:
      // Antigravity wraps Gemini shape in body.request — handled below.
...
// Insert before the last cache_control block to keep the injected block
