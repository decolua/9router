...
export function getStaticCapabilitiesForModel(provider, model) {
  return resolveRegisteredCaps(provider, model);
}
 ...
 * @returns {object} full capabilities object
 */
// Registered view (tables + catalog), shared by the static and effective
// resolvers below. Kept private; both exports layer their own semantics on it.
function resolveRegisteredCaps(provider, model) {
...
export function getCapabilitiesForModel(provider, model) {
  return applyContextOverrides(resolveRegisteredCaps(provider, model), model, provider);
}
