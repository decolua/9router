...
import type { OpenAIFinishReason, ClaudeStopReason } from "../../types/finishReason.js";
...
export function fromOpenAIFinish(reason: OpenAIFinishReason | string | null | undefined, format: string): string | OpenAIFinishReason | ClaudeStopReason | null | undefined {
  switch (format) {
    case "claude":
      switch (reason) {
