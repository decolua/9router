...
export function canonicalizeUsage(usage) {
  ...
  // carries cache_creation_input_tokens, so check both fields. Guard on the
  // absence of cached_tokens to keep this idempotent.
...
export function mergeUsage(prev, next) {
  ...
  for (const [k, v] of Object.entries(next)) {
    ...
    // chunk can't poison the whole accumulation.
