        ...
        transform(chunk, controller) {
            ...
            for (const line of lines) {
                ...
                if (parsed.choices?.[0]?.delta?.content) {
                    totalContentLength +=
                        parsed.choices[0].delta.content.length;
                ...
                if (translated?.length > 0) {
                    for (const item of translated) {
                        ...
                        if (
                            ...
                            item.usage = filterUsageForFormat(
                                estimated,
                                sourceFormat,
                            ); // Filter + already has buffer
