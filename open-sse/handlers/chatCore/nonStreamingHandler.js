 ...
 */
export async function handleNonStreamingResponse({ providerResponse, provider, model, sourceFormat, targetFormat, body, stream, translatedBody, finalBody, requestStartTime, connectionId, apiKey, userId, apiKeyId, clientRawRequest, onRequestSuccess, reqLogger, trackDone, appendLog }) {
  trackDone();
  ...
  saveUsageStats({ provider, model, tokens: usage, connectionId, apiKey, userId, apiKeyId, endpoint: clientRawRequest?.endpoint });
