...
import { selectAbortTerminalBuilder } from "../../utils/streamTerminalBuilders.js";
 ...
 */
export function handleStreamingResponse({ providerResponse, provider, model, sourceFormat, targetFormat, userAgent, body, stream, translatedBody, finalBody, requestStartTime, connectionId, apiKey, onRequestSuccess, reqLogger, toolNameMap, streamController, onStreamComplete, streamDetailId }) {
  if (onRequestSuccess) onRequestSuccess();

  const transformStream = buildTransformStream({ provider, sourceFormat, targetFormat, userAgent, reqLogger, toolNameMap, model, connectionId, body, onStreamComplete, apiKey });

  // Pick the client-format abort terminal, not the provider format.
  const onAbortTerminal = selectAbortTerminalBuilder(sourceFormat);
