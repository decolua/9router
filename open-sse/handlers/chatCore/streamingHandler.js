 ...
 */
export function buildOnStreamComplete({ provider, model, connectionId, apiKey, usageReservationId, requestStartTime, body, stream, finalBody, translatedBody, clientRawRequest, pxpipe, reqTag, log }) {
  ...
  const onStreamComplete = (contentObj, usage, ttftAt) => {
    ...
    saveUsageStats({ provider, model, tokens: usage, connectionId, apiKey, usageReservationId, endpoint: clientRawRequest?.endpoint, label: "STREAM USAGE", silent: true });
