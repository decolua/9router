 ...
 */
export function buildOnStreamComplete({ provider, model, requestedModel, actualModel, routerSelectedModel, routerSelectedProvider, requestDetailId, connectionId, apiKey, requestStartTime, body, stream, finalBody, translatedBody, clientRawRequest, pxpipe, reqTag, log }) {
  const streamDetailId = requestDetailId;
  ...
  const onStreamComplete = (contentObj, usage, ttftAt) => {
    ...
    saveUsageStats({ provider, model, requestedModel, actualModel, routerSelectedModel, routerSelectedProvider, requestDetailId, tokens: usage, connectionId, apiKey, endpoint: clientRawRequest?.endpoint, latency, label: "STREAM USAGE", silent: true });
