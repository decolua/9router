...
// Mock DNS so the SSRF guard treats example.com as public. Runtime requests
// `{ all: true }`, so preserve Node's array return shape for that option.
vi.mock("node:dns/promises", () => ({
  lookup: async (_host, options) => options?.all
