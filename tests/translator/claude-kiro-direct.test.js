...
describe("Claude → Kiro (direct route)", () => {
  ...
  it("sends Claude system as user-content fallback and never top-level systemPrompt", () => {
    const out = C2K({
  ...
  it("keeps systemPrompt undefined across turns while content retains instructions", () => {
    const first = C2K({
