<div align="center">
  ...
  **Connect All AI Code Tools (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) to 40+ AI Providers & 100+ Models.**
  ...
  [![Downloads](https://img.shields.io/npm/dm/durindoor.svg)](https://www.npmjs.com/package/durindoor)
  [![Docker Pulls](https://img.shields.io/docker/pulls/decolua/durindoor.svg?logo=docker&label=Docker%20pulls)](https://hub.docker.com/r/decolua/durindoor)
  [![GHCR](https://img.shields.io/badge/GHCR-decolua%2Fdurindoor-blue?logo=github)](https://github.com/decolua/9router/pkgs/container/9router)
  [![License](https://img.shields.io/npm/l/durindoor.svg)](https://github.com/decolua/9router/blob/main/LICENSE)

  <a href="https://trendshift.io/repositories/22628" target="_blank"><img src="https://trendshift.io/api/badge/repositories/22628" alt="decolua%2FDurinDoor | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
  
  [🚀 Quick Start](#-quick-start) • [💡 Features](#-key-features) • [📖 Setup](#-setup-guide) • [🌐 Website](https://durindoor.com)
...
This repository package is private (`durindoor-app`), so source/Docker execution is the expected local development path.
...
<table>
  <tr>
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>DurinDoor + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Tiết kiệm chi phí LLM cho OpenClaw với DurinDoor<br/>by <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
    </td>
    <td align="center" width="320">
  ...
  <tr>
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>Claude CLI Free Setup with DurinDoor 🚀<br/>by <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + DurinDoor<br/>by <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
    <td align="center" width="320">
  ...
  <tr>
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Quick Setup DurinDoor 🚀<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=TXGv4eofe1I">
        <img src="https://img.youtube.com/vi/TXGv4eofe1I/mqdefault.jpg" alt="Cara Deploy DurinDoor di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB" width="300"/>
      </a><br/>
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Cara Deploy DurinDoor di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
</table>
...
> 🎬 **Made a video about DurinDoor?** Submit a [Pull Request](https://github.com/decolua/9router/pulls) adding your video to this section — we'll merge it!

---

## 🛠️ Supported CLI Tools

DurinDoor works seamlessly with all major AI coding tools:
...
Headroom is optional and runs separately. DurinDoor calls Headroom's local `/v1/compress` endpoint, then keeps normal routing, fallback, auth, and usage tracking:

```
Client → DurinDoor → Headroom /v1/compress → DurinDoor → provider
```
...
If Headroom is down or returns an error, DurinDoor fails open and sends the original request.
...
- Your CLI tool sends OpenAI format → DurinDoor translates → Provider receives native format
...
> DurinDoor itself **never charges** you anything. You only pay providers directly (if using paid services).
> 
...
### 📊 Understanding DurinDoor Costs & Billing

**DurinDoor Billing Reality:**

✅ **DurinDoor software = FREE forever** (open source, never charges)  
✅ **Dashboard "costs" = Display/tracking only** (not actual bills)  
✅ **You pay providers directly** (subscriptions or API fees)  
✅ **FREE providers stay FREE** (iFlow, Kiro, Qwen = $0 unlimited)  
❌ **DurinDoor never sends invoices** or charges your card
...
- **Cheap providers** (GLM, MiniMax): Pay them directly, DurinDoor just routes
- **FREE providers** (iFlow, Kiro, Qwen): Genuinely free forever, no hidden charges
- **DurinDoor**: Never charges anything, ever
...
The dashboard tracks your token usage and displays **estimated costs** as if you were using paid APIs directly. This is **not actual billing** - it's a reference to show how much you're saving by using free models or existing subscriptions through DurinDoor.
...
<details>
<summary><b>💳 Will I be charged by DurinDoor?</b></summary>

**No.** DurinDoor is free, open-source software that runs on your own computer. It never charges you anything.

**You only pay:**
- ✅ **Subscription providers** (Claude Code $20/mo, Codex $20-200/mo) → Pay them directly on their websites
- ✅ **Cheap providers** (GLM, MiniMax) → Pay them directly, DurinDoor just routes your requests
- ❌ **DurinDoor itself** → **Never charges anything, ever**

DurinDoor is a local proxy/router. It doesn't have your credit card, can't send invoices, and has no billing system. It's completely free software.
...
DurinDoor just routes your requests to them - there's no "catch" or future billing. They're truly free services, and DurinDoor makes them easy to use with fallback support.
...
3. **Use subscription providers last:**
   ...
   - DurinDoor helps maximize their value through quota tracking
...
DurinDoor's smart fallback prevents surprise charges:
...
**You're in control:** Set spending limits per provider in dashboard, and DurinDoor respects them.
...
**Pro Tip:** Use Opus for complex tasks, Sonnet for speed. DurinDoor tracks quota per model!
...
> **Note:** OpenClaw only works with local DurinDoor. Use `127.0.0.1` instead of `localhost` to avoid IPv6 resolution issues.
...
export NEXT_PUBLIC_CLOUD_URL="https://durindoor.com"
...
- Docker Hub: [`decolua/durindoor`](https://hub.docker.com/r/decolua/durindoor)
- GHCR: [`ghcr.io/decolua/durindoor`](https://github.com/decolua/9router/pkgs/container/9router)
...
docker run -d --name durindoor -p 20128:20128 \
  -v "$HOME/.durindoor:/app/data" -e DATA_DIR=/app/data durindoor
```
...
docker pull decolua/durindoor:latest   # update to latest
```

**Data persistence:** `$HOME/.durindoor/db/data.sqlite` on host ↔ `/app/data/db/data.sqlite` in container.

### Environment Variables

| Variable | Default | Description |
|----------|---------|-------------|
| `JWT_SECRET` | Auto-generated (`~/.durindoor/jwt-secret`) | JWT signing secret for dashboard auth cookie (override to share across instances) |
| `INITIAL_PASSWORD` | `123456` | First login password when no saved hash exists |
| `DATA_DIR` | `~/.durindoor` | Main app data location (SQLite at `$DATA_DIR/db/data.sqlite`) |
| `PORT` | framework default | Service port (`20128` in examples) |
| `HOSTNAME` | framework default | Bind host (Docker defaults to `0.0.0.0`) |
| `NODE_ENV` | runtime default | Set `production` for deploy |
| `BASE_URL` | `http://localhost:20128` | Server-side internal base URL used by cloud sync jobs |
| `CLOUD_URL` | `https://durindoor.com` | Server-side cloud sync endpoint base URL |
| `NEXT_PUBLIC_BASE_URL` | `http://localhost:3000` | Backward-compatible/public base URL (prefer `BASE_URL` for server runtime) |
| `NEXT_PUBLIC_CLOUD_URL` | `https://durindoor.com` | Backward-compatible/public cloud URL (prefer `CLOUD_URL` for server runtime) |
...
- Both `${DATA_DIR}` and `~/.durindoor` resolve to the same location in a Docker container — the symlink `/root/.durindoor -> /app/data` is created at build time.
...
- **Website**: [durindoor.com](https://durindoor.com)
...
Thanks to all contributors who helped make DurinDoor better!

[![Contributors](https://contrib.rocks/image?repo=decolua/durindoor&max=150&columns=15&anon=1&v=20260309)](https://github.com/decolua/9router/graphs/contributors)

---

## 📊 Star Chart

[![Star Chart](https://starchart.cc/decolua/durindoor.svg?variant=adaptive)](https://starchart.cc/decolua/durindoor)



## 🔀 Forks

**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — A full-featured TypeScript fork of DurinDoor. Adds 36+ providers, 4-tier auto-fallback, multi-modal APIs (images, embeddings, audio, TTS), circuit breaker, semantic cache, LLM evaluations, and a polished dashboard. 368+ unit tests. Available via npm and Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Rust token-saver. DurinDoor ports its compression pipeline to JS → **−20-40% input tokens** on every request.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) by **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral *"why use many token when few token do trick"*. DurinDoor adapts its prompt → **−65% output tokens**.

Huge thanks to these authors — without their work, DurinDoor's token-saving features wouldn't exist. ⭐ them on GitHub!
