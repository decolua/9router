<div align="center">
  <img src="./images/9rudy.png?1" alt="9Rudy Dashboard" width="800"/>
  
  # 9Rudy - FREE AI Router & Token Saver
  
  **Never stop coding. Save 20-40% tokens with RTK + auto-fallback to FREE & cheap AI models.**
  
  **Connect All AI Code Tools (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) to 40+ AI Providers & 100+ Models.**
  
  [![npm](https://img.shields.io/npm/v/9rudy.svg)](https://www.npmjs.com/package/9rudy)
  [![Downloads](https://img.shields.io/npm/dm/9rudy.svg)](https://www.npmjs.com/package/9rudy)
  [![Docker Pulls](https://img.shields.io/docker/pulls/decolua/9rudy.svg?logo=docker&label=Docker%20pulls)](https://hub.docker.com/r/decolua/9rudy)
  [![GHCR](https://img.shields.io/badge/GHCR-decolua%2F9rudy-blue?logo=github)](https://github.com/decolua/9rudy/pkgs/container/9rudy)
  [![License](https://img.shields.io/npm/l/9rudy.svg)](https://github.com/decolua/9rudy/blob/main/LICENSE)

  <a href="https://trendshift.io/repositories/22628" target="_blank"><img src="https://trendshift.io/api/badge/repositories/22628" alt="decolua%2F9rudy | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
  
  [🚀 Quick Start](#-quick-start) • [💡 Features](#-key-features) • [📖 Setup](#-setup-guide) • [🌐 Website](https://9rudy.com)
...
This repository package is private (`9rudy-app`), so source/Docker execution is the expected local development path.
...
<table>
  <tr>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
        <img src="https://img.youtube.com/vi/raEyZPg5xE0/maxresdefault.jpg" alt="9Rudy Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 English</b><br/>
      <sub>9Rudy + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=X69n5Lm06Yw">
        <img src="https://img.youtube.com/vi/X69n5Lm06Yw/maxresdefault.jpg" alt="Tiết kiệm chi phí LLM với 9Rudy" width="300"/>
      </a><br/>
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Tiết kiệm chi phí LLM cho OpenClaw với 9Rudy<br/>by <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
    </td>
    <td align="center" width="320">
  ...
  <tr>
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>Claude CLI Free Setup with 9Rudy 🚀<br/>by <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + 9Rudy<br/>by <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
    <td align="center" width="320">
...
> 🎬 **Made a video about 9Rudy?** Submit a [Pull Request](https://github.com/decolua/9rudy/pulls) adding your video to this section — we'll merge it!

---

## 🛠️ Supported CLI Tools

9Rudy works seamlessly with all major AI coding tools:
...
- Your CLI tool sends OpenAI format → 9Rudy translates → Provider receives native format
...
> 9Rudy itself **never charges** you anything. You only pay providers directly (if using paid services).
> 
...
### 📊 Understanding 9Rudy Costs & Billing

**9Rudy Billing Reality:**

✅ **9Rudy software = FREE forever** (open source, never charges)  
✅ **Dashboard "costs" = Display/tracking only** (not actual bills)  
✅ **You pay providers directly** (subscriptions or API fees)  
✅ **FREE providers stay FREE** (iFlow, Kiro, Qwen = $0 unlimited)  
❌ **9Rudy never sends invoices** or charges your card
...
- **Cheap providers** (GLM, MiniMax): Pay them directly, 9Rudy just routes
- **FREE providers** (iFlow, Kiro, Qwen): Genuinely free forever, no hidden charges
- **9Rudy**: Never charges anything, ever
...
The dashboard tracks your token usage and displays **estimated costs** as if you were using paid APIs directly. This is **not actual billing** - it's a reference to show how much you're saving by using free models or existing subscriptions through 9Rudy.
...
<details>
<summary><b>💳 Will I be charged by 9Rudy?</b></summary>

**No.** 9Rudy is free, open-source software that runs on your own computer. It never charges you anything.

**You only pay:**
- ✅ **Subscription providers** (Claude Code $20/mo, Codex $20-200/mo) → Pay them directly on their websites
- ✅ **Cheap providers** (GLM, MiniMax) → Pay them directly, 9Rudy just routes your requests
- ❌ **9Rudy itself** → **Never charges anything, ever**

9Rudy is a local proxy/router. It doesn't have your credit card, can't send invoices, and has no billing system. It's completely free software.
...
9Rudy just routes your requests to them - there's no "catch" or future billing. They're truly free services, and 9Rudy makes them easy to use with fallback support.
...
3. **Use subscription providers last:**
   ...
   - 9Rudy helps maximize their value through quota tracking
...
9Rudy's smart fallback prevents surprise charges:
...
**You're in control:** Set spending limits per provider in dashboard, and 9Rudy respects them.
...
**Pro Tip:** Use Opus for complex tasks, Sonnet for speed. 9Rudy tracks quota per model!
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from 9rudy dashboard]
...
```json
{
  ...
  "anthropic_api_key": "your-9rudy-api-key"
}
```
...
export OPENAI_API_KEY="your-9rudy-api-key"
...
```json
{
  "agents": {
    "defaults": {
      "model": {
        "primary": "9rudy/kr/claude-sonnet-4.5"
      }
    }
  },
  "models": {
...
> **Note:** OpenClaw only works with local 9Rudy. Use `127.0.0.1` instead of `localhost` to avoid IPv6 resolution issues.
...
```bash
# Clone and install
git clone https://github.com/decolua/9rudy.git
cd 9rudy
npm install
npm run build
...
export DATA_DIR="/var/lib/9rudy"
export PORT="20128"
export HOSTNAME="0.0.0.0"
export NODE_ENV="production"
export NEXT_PUBLIC_BASE_URL="http://localhost:20128"
export NEXT_PUBLIC_CLOUD_URL="https://9rudy.com"
...
# Or use PM2
npm install -g pm2
pm2 start npm --name 9rudy -- start
pm2 save
pm2 startup
```
...
- Docker Hub: [`decolua/9rudy`](https://hub.docker.com/r/decolua/9rudy)
- GHCR: [`ghcr.io/decolua/9rudy`](https://github.com/decolua/9rudy/pkgs/container/9rudy)
...
docker run -d \
  --name 9rudy \
  -p 20128:20128 \
  -v "$HOME/.9rudy:/app/data" \
  -e DATA_DIR=/app/data \
  decolua/9rudy:latest
```
...
git clone https://github.com/decolua/9rudy.git
cd 9rudy/app
docker build -t 9rudy .
docker run -d --name 9rudy -p 20128:20128 \
  -v "$HOME/.9rudy:/app/data" -e DATA_DIR=/app/data 9rudy
```
...
```bash
docker logs -f 9rudy
docker restart 9rudy
docker stop 9rudy && docker rm 9rudy
docker pull decolua/9rudy:latest   # update to latest
```

**Data persistence:** `$HOME/.9rudy/db/data.sqlite` on host ↔ `/app/data/db/data.sqlite` in container.

### Environment Variables

| Variable | Default | Description |
|----------|---------|-------------|
| `JWT_SECRET` | Auto-generated (`~/.9rudy/jwt-secret`) | JWT signing secret for dashboard auth cookie (override to share across instances) |
| `INITIAL_PASSWORD` | `123456` | First login password when no saved hash exists |
| `DATA_DIR` | `~/.9rudy` | Main app data location (SQLite at `$DATA_DIR/db/data.sqlite`) |
| `PORT` | framework default | Service port (`20128` in examples) |
| `HOSTNAME` | framework default | Bind host (Docker defaults to `0.0.0.0`) |
| `NODE_ENV` | runtime default | Set `production` for deploy |
| `BASE_URL` | `http://localhost:20128` | Server-side internal base URL used by cloud sync jobs |
| `CLOUD_URL` | `https://9rudy.com` | Server-side cloud sync endpoint base URL |
| `NEXT_PUBLIC_BASE_URL` | `http://localhost:3000` | Backward-compatible/public base URL (prefer `BASE_URL` for server runtime) |
| `NEXT_PUBLIC_CLOUD_URL` | `https://9rudy.com` | Backward-compatible/public cloud URL (prefer `CLOUD_URL` for server runtime) |
...
- Both `${DATA_DIR}` and `~/.9rudy` resolve to the same location in a Docker container — the symlink `/root/.9rudy -> /app/data` is created at build time.
...
- **Website**: [9rudy.com](https://9rudy.com)
- **GitHub**: [github.com/decolua/9rudy](https://github.com/decolua/9rudy)
- **Issues**: [github.com/decolua/9rudy/issues](https://github.com/decolua/9rudy/issues)

---

## 👥 Contributors

Thanks to all contributors who helped make 9Rudy better!

[![Contributors](https://contrib.rocks/image?repo=decolua/9rudy&max=150&columns=15&anon=1&v=20260309)](https://github.com/decolua/9rudy/graphs/contributors)

---

## 📊 Star Chart

[![Star Chart](https://starchart.cc/decolua/9rudy.svg?variant=adaptive)](https://starchart.cc/decolua/9rudy)



## 🔀 Forks

**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — A full-featured TypeScript fork of 9Rudy. Adds 36+ providers, 4-tier auto-fallback, multi-modal APIs (images, embeddings, audio, TTS), circuit breaker, semantic cache, LLM evaluations, and a polished dashboard. 368+ unit tests. Available via npm and Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Rust token-saver. 9Rudy ports its compression pipeline to JS → **−20-40% input tokens** on every request.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) by **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral *"why use many token when few token do trick"*. 9Rudy adapts its prompt → **−65% output tokens**.

Huge thanks to these authors — without their work, 9Rudy's token-saving features wouldn't exist. ⭐ them on GitHub!
