...
- Primer arranque: se imprime un token de configuración de un solo uso en la consola — abre `/setup` y pégalo para establecer tu contraseña (no hay contraseña por defecto)
