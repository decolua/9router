          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-bold text-lg">Start 9Router</h4>
                  <p className="text-sm text-gray-500 mt-1">Run the Docker image to start the server instantly</p>
                </div>
              </div>
            ...
            <div className="rounded-xl overflow-hidden bg-[#1e1e1e] border border-[#3a2f27] shadow-2xl">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-auto">
                <div
                  ...
                  onClick={() => handleCopy("docker run -p 20128:20128 decolua/9router:latest")}
                >
                  <span className="text-green-400">$</span>
                  <span className="text-white">docker run -p 20128:20128 decolua/9router:latest</span>
