...
const SAFE_FIELDS = [
  ...
  "createdAt", "updatedAt",
  // Per-account quota safety buffer (non-sensitive): threshold + last snapshot,
  // so the Quota Tracker edit modal can show/remember the configured value.
  "quotaPauseThreshold", "lastQuotaSnapshot",
];
