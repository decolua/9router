...
export async function POST(request) {
  try {
    ...
    // OpenAI-compatible nodes can use multiple API keys for the same base URL.
    // Anthropic-compatible and custom embedding nodes still represent single-key
    // endpoints in the current UI/model routing flow.
