...
type TunnelSettings = { tunnelUrl?: string | null; tailscaleUrl?: string | null; tunnelDashboardAccess?: boolean | null };

function isTunnelRequest(request: NextRequest, settings: TunnelSettings): boolean {
