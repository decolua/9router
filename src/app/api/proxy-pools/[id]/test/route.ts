...
export async function POST(_request: NextRequest, context: { params: Promise<{ id: string }> }) {
  try {
    ...
    const poolType = typeof proxyPool["type"] === "string" ? proxyPool["type"] : "";
    const proxyUrl = typeof proxyPool["proxyUrl"] === "string" ? proxyPool["proxyUrl"] : "";
    const result: RelayResult =
      poolType === "vercel" || poolType === "cloudflare" || poolType === "deno"
        ? await testVercelRelay(proxyUrl)
