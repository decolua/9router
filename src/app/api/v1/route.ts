...
import { buildModelsList, LLM_KIND } from "./models/buildModelsList.js";
...
/**
 * GET /v1 - OpenAI compatible models list (LLM/chat models only).
 * Mirrors /v1/models — this root endpoint is consumed by codex_cli_rs.
 */
