  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold">{i18nText("Combos")}</h1>
          <p className="text-sm text-text-muted mt-1">
            {i18nText("Create model combos with fallback support")}
          </p>
        </div>
        <Button icon="add" onClick={() => setShowCreateModal(true)}>
          {i18nText("Create Combo")}
        </Button>
      </div>
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                title={i18nText("Copy combo name")}
              >
  ...
  return (
    <>
        ...
        <div className="flex flex-col gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-text-muted mt-0.5">
              {i18nText("Only letters, numbers, - and _ allowed")}
            </p>
          </div>
      ...
      <ModelSelectModal
        ...
        title={i18nText("Add Model to Combo")}
      />
    </>
  );
}
