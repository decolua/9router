...
const AUTO_PING_TOOLTIPS = {
  ...
  codex: "Auto-starts the next 5h Codex window after reset by sending a tiny request using the configured Codex auto-ping model. Consumes a small amount of quota.",
};
