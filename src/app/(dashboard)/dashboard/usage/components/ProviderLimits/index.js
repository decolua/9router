        ...
        <div className="flex flex-wrap items-center gap-1.5">
          <div className="relative">
            <button
              ...
              className="flex h-8 items-center justify-between gap-1 rounded-lg border border-border px-2 text-xs text-text-main transition-colors bg-surface-2 hover:bg-surface-3"
              aria-haspopup="menu"
            ...
            {providerMenuOpen && (
              <>
                ...
                />
                <div className="absolute left-0 z-40 mt-2 w-64 overflow-hidden rounded-2xl border border-border bg-surface/95 p-1.5 shadow-xl backdrop-blur sm:w-72">
                  <button
                    type="button"
                    onClick={() => {
          ...
          <select
            ...
            className="h-8 rounded-lg border border-border bg-surface-2 px-2 text-xs text-text-main outline-none transition-colors hover:bg-surface-3"
                    ...
                    {conn.provider === "claude" && conn.authType === "oauth" && (
                      <Tooltip text="When your 5h quota runs out, auto-sends a request the moment it resets so a new window starts right away.">
                        <button
                          ...
                          className={`flex h-8 w-8 items-center justify-center rounded-lg transition-colors hover:bg-surface-2 ${autoPingMap[conn.id] === true ? "text-primary" : "text-text-muted"}`}
                        >
          ...
          <div className="flex flex-wrap items-center justify-between gap-2">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <input
                ...
                className="h-8 w-20 rounded-lg border border-border bg-surface-2 px-2 text-xs text-text-main outline-none transition-colors hover:bg-surface-3"
