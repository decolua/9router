  ...
  return (
    <Card padding="xs" className="overflow-hidden">
        ...
        <div className="mt-4 pt-4 border-t border-border flex flex-col gap-4">
          {checkingCodex && (
            <div className="flex items-center gap-2 text-text-muted">
              ...
              <span>{i18nText("Checking Codex CLI...")}</span>
            </div>
          )}
              ...
              <div className="flex items-center gap-3 p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
                ...
                <div className="flex-1">
                  <p className="font-medium text-yellow-600 dark:text-yellow-400">
                    {i18nText("Codex CLI not installed")}
                  </p>
              ...
              {showInstallGuide && (
                <div className="p-4 bg-surface border border-border rounded-lg">
                  <h4 className="font-medium mb-3">
                    {i18nText("Installation Guide")}
                  </h4>
                  <div className="space-y-3 text-sm">
                    <div>
                      <p className="text-text-muted mb-1">
                        {i18nText("macOS / Linux / Windows:")}
                      </p>
                      <code className="block px-3 py-2 bg-black/5 dark:bg-white/5 rounded font-mono text-xs">
                        {i18nText("npm install -g @openai/codex")}
                      </code>
                    </div>
                    <p className="text-text-muted">
                      {i18nText("After installation, run")}
                    ...
                    <div className="pt-2 border-t border-border">
                      <p className="text-text-muted text-xs">
                        {i18nText("Codex uses")}
                        <code className="px-1 bg-black/5 dark:bg-white/5 rounded">
                          {i18nText("~/.codex/auth.json")}
                        </code>
                        {i18nText("with")}
                        <code className="px-1 bg-black/5 dark:bg-white/5 rounded">
                          OPENAI_API_KEY
                        </code>
                        {i18nText('. Click "Apply" to auto-configure.')}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  {customBaseUrl && customBaseUrl !== `${baseUrl}/v1` && (
                    <button
                      ...
                      title={i18nText("Reset to default")}
                    >
      ...
      <ModelSelectModal
        ...
        title={i18nText("Select Model for Codex")}
      />

      <ManualConfigModal
        isOpen={showManualConfigModal}
        onClose={() => setShowManualConfigModal(false)}
        title={i18nText("Codex CLI - Manual Configuration")}
