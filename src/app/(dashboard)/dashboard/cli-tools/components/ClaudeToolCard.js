  ...
  return (
    <Card padding="xs" className="overflow-hidden">
        ...
        <div className="mt-4 pt-4 border-t border-border flex flex-col gap-4">
          {checkingClaude && (
            <div className="flex items-center gap-2 text-text-muted">
              ...
              <span>{i18nText("Checking Claude CLI...")}</span>
            </div>
          )}
              ...
              <div className="flex items-center gap-3 p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
                ...
                <div className="flex-1">
                  <p className="font-medium text-yellow-600 dark:text-yellow-400">
                    {i18nText("Claude CLI not installed")}
                  </p>
                  <p className="text-sm text-text-muted">
                    {i18nText("Please install Claude CLI to use this feature.")}
                  </p>
                </div>
                <Button
                  variant="outline"
                  ...
                  <div className="space-y-3 text-sm">
                    <div>
                      ...
                      <code className="block px-3 py-2 bg-black/5 dark:bg-white/5 rounded font-mono text-xs">
                        {i18nText("npm install -g @anthropic-ai/claude-code")}
                      </code>
                    </div>
      ...
      <ManualConfigModal
        ...
        title={i18nText("Claude CLI - Manual Configuration")}
