...
const STATUS_CONFIG = {
  available: {
    icon: "check_circle",
    color: "#22c55e",
    label: i18nText("Available"),
  },
  cooldown: {
    icon: "schedule",
    color: "#f59e0b",
    label: i18nText("Cooldown"),
  },
  unavailable: {
    icon: "error",
    color: "#ef4444",
    label: i18nText("Unavailable"),
  },
  unknown: {
    icon: "help",
    color: "#6b7280",
    label: i18nText("Unknown"),
  },
};
          ...
          <div className="px-4 py-3 max-h-60 overflow-y-auto">
            {isHealthy ? (
              <p className="text-sm text-text-muted text-center py-2">
                {i18nText("All models are responding normally.")}
              </p>
            ) : (
