...
export default function ConnectionRow({ connection, proxyPools, isOAuth, isFirst, isLast, onMoveUp, onMoveDown, onDragHandle, onToggleActive, onUpdateProxy, onEdit, onDelete, oneByOneStatus = null }) {
