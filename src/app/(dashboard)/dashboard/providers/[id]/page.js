            ...
            <div className="flex gap-2">
              {providerId === "iflow" && (
                <Button
                  ...
                  title={i18nText("Add connection using browser cookie")}
                >
                  {i18nText("Cookie")}
                </Button>
              )}
      ...
      <div className="flex items-center gap-2">
        ...
        {isCustom && (
          <button
            ...
            title={i18nText("Remove custom model")}
          >
...
function AddCustomModelModal({
  ...
  const handleTest = async () => {
    ...
    try {
      const res = await fetch("/api/models/test", {
        ...
        body: JSON.stringify({
          model: `${providerAlias}/${modelId.trim()}`,
        }),
      });
      const data = await res.json();
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={i18nText("Add Custom Model")}
    >
      <div className="flex flex-col gap-4">
        <div>
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder={i18nText("e.g. claude-opus-4-5")}
