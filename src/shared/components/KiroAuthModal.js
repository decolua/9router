        ...
        {selectedMethod === "import" && (
          <div className="space-y-4">
            <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg border border-blue-200 dark:border-blue-800 mb-4">
              <p className="text-sm text-blue-800 dark:text-blue-200">💡 Please login to Kiro IDE first.</p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-text-muted mt-1">
                Find it in Kiro IDE at:{" "}
                <code className="bg-sidebar px-1 rounded">~/.aws/sso/cache/kiro-auth-token.json</code>
              </p>
            </div>
