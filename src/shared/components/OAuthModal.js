      ...
      <div className="flex flex-col gap-4">
        ...
        {step === "waiting" && !isDeviceCode && (
          <div className="text-center py-6">
            ...
            <h3 className="text-lg font-semibold mb-2">
              {i18nText("Waiting for Authorization")}
            </h3>
            <p className="text-sm text-text-muted mb-4">
              {i18nText("Complete the authorization in the popup window.")}
            </p>
            <Button variant="ghost" onClick={() => setStep("input")}>
              {i18nText("Popup blocked? Enter URL manually")}
            </Button>
          </div>
        )}
        ...
        {step === "waiting" && isDeviceCode && deviceData && (
          <>
            <div className="text-center py-4">
              <p className="text-sm text-text-muted mb-4">
                {i18nText("Visit the URL below and enter the code:")}
              </p>
              <div className="bg-sidebar p-4 rounded-lg mb-4">
                <p className="text-xs text-text-muted mb-1">
                  {i18nText("Verification URL")}
                </p>
            ...
            <div className="space-y-4">
              <div>
                <p className="text-sm font-medium mb-2">
                  {i18nText("Step 1: Open this URL in your browser")}
                </p>
              ...
              <div>
                <p className="text-sm font-medium mb-2">
                  {i18nText("Step 2: Paste the callback URL here")}
                </p>
        ...
        {step === "success" && (
          <div className="text-center py-6">
            ...
            <h3 className="text-lg font-semibold mb-2">
              {i18nText("Connected Successfully!")}
            </h3>
            <p className="text-sm text-text-muted mb-4">
              {i18nText("Your")}
              {providerInfo.name}
              {i18nText("account has been connected.")}
            </p>
