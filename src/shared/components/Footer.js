...
const footerLinks = {
  product: [
    {
      label: i18nText("Features"),
      href: "#features",
    },
    {
      label: i18nText("Pricing"),
      href: "#pricing",
    },
    {
      label: i18nText("Changelog"),
      href: "#",
    },
  ],
  resources: [
    {
      label: i18nText("Documentation"),
      href: "#",
    },
    {
      label: i18nText("API Reference"),
      href: "#",
    },
    {
      label: i18nText("Help Center"),
      href: "#",
    },
  ],
  company: [
    {
      label: i18nText("About"),
      href: "#",
    },
    {
      label: i18nText("Blog"),
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-text-muted">
            ...
            {i18nText("Inc. All rights reserved.")}
          </p>
