...
export const APIKEY_PROVIDERS = {
  ...
  "crof-ai": { id: "crof-ai", alias: "crof", name: "Crof AI", icon: "auto_awesome", color: "#111827", textIcon: "CR", website: "https://crof.ai", notice: { apiKeyUrl: "https://crof.ai/docs" }, passthroughModels: true, serviceKinds: ["llm", "imageToText"] },
