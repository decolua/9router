...
export const APIKEY_PROVIDERS = {
  ...
  x5lab: { id: "x5lab", alias: "x5l", name: "X5Lab", icon: "science", color: "#6366F1", textIcon: "X5", website: "https://x5lab.dev", notice: { text: "22+ AI models via single endpoint. API key starts with x5-.", apiKeyUrl: "https://api.x5lab.dev/discord" }, passthroughModels: true, modelsFetcher: { url: "https://api.x5lab.dev/v1/models", type: "openai" } },
