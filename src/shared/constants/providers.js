...
export const FREE_TIER_PROVIDERS = {
  ...
  modelscope: { id: "modelscope", alias: "ms", name: "ModelScope", icon: "smart_toy", color: "#FF6A00", textIcon: "MS", website: "https://modelscope.cn", notice: { text: "ModelScope Inference API — OpenAI-compatible endpoint with GLM, Qwen, DeepSeek, Kimi, MiniMax and more. Free tier available.", apiKeyUrl: "https://modelscope.cn/my/myaccesstoken" }, serviceKinds: ["llm"], thinkingConfig: THINKING_CONFIG.extended },
};
