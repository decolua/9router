...
export const APIKEY_PROVIDERS = {
  ...
  astraflow: { id: "astraflow", alias: "astraflow", name: "Astraflow", icon: "cloud", color: "#0052D9", textIcon: "AF", website: "https://astraflow.ucloud-global.com", notice: { text: "Astraflow by UCloud — OpenAI-compatible platform supporting 200+ models (global endpoint).", apiKeyUrl: "https://astraflow.ucloud-global.com" } },
  "astraflow-cn": { id: "astraflow-cn", alias: "astraflow-cn", name: "Astraflow (China)", icon: "cloud", color: "#0052D9", textIcon: "AFC", website: "https://astraflow.ucloud.cn", notice: { text: "Astraflow by UCloud — OpenAI-compatible platform supporting 200+ models (China endpoint).", apiKeyUrl: "https://astraflow.ucloud.cn" } },
