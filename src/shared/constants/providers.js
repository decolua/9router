...
export const FREE_TIER_PROVIDERS = {
  ...
  hcnsec: { id: "hcnsec", alias: "hcnsec", name: "Huancheng Public API", icon: "security", color: "#0EA5E9", textIcon: "HC", website: "https://api.hcnsec.cn", notice: { text: "Xinjiang Huancheng Cybersecurity public LLM API platform: free credits with daily check-ins.", apiKeyUrl: "https://api.hcnsec.cn" }, passthroughModels: true, serviceKinds: ["llm", "image"] },
