...
export const FREE_PROVIDERS = {
  ...
  devin: { id: "devin", alias: "dv", name: "Devin AI", icon: "smart_toy", color: "#6366F1", textIcon: "DV", website: "https://devin.ai", notice: { apiKeyUrl: "https://app.devin.ai/settings/service-users" } },
