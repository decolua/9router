...
function createChunk(state: any, delta: any, finishReason: string | null = null) {
  return {
...
function convertStopReason(reason: string) {
  switch (reason) {
...
register(FORMATS.CLAUDE_OAUTH, FORMATS.OPENAI, null, claudeToOpenAIResponse);
