...
export const TABLES = {
  ...
  apiKeyGroups: {
    ...
    indexes: ["CREATE INDEX IF NOT EXISTS idx_akg_name ON apiKeyGroups(name)"],
  },
  combos: {
    columns: {
      id: "TEXT PRIMARY KEY",
    ...
    indexes: [
      ...
      "CREATE INDEX IF NOT EXISTS idx_combo_list ON combos(listId)",
    ],
  },
  comboLists: {
    columns: {
    ...
    indexes: ["CREATE INDEX IF NOT EXISTS idx_cl_sort ON comboLists(sortOrder)"],
  },
  kv: {
    columns: {
      scope: "TEXT NOT NULL",
