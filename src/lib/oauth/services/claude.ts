...
export class ClaudeService extends OAuthService {
   ...
   */
  buildClaudeAuthUrl(redirectUri: string, state: string, codeChallenge: string) {
   ...
   */
  async exchangeClaudeCode(code: string, redirectUri: string, codeVerifier: string, state: string) {
